...
{
    int n = 4;
    connection_t q1_t2_connections[4][4] = {
        {{0, 0}, {1, 1}, {2, 2}, {INT_MAX, INT_MAX}},
        {{INT_MAX, INT_MAX}, {0, 0}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}},
        {{INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {0, 0}, {3, 3}},
        {{4, 1}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {0, 0}}};

    if (!q1(n, q1_t2_connections))
    {
        printf("Q1 TestCase 3: " PASSED);
    }
    else
    {
        printf("Q1 TestCase 3: " FAILED);
    }
}
{
    int n = 1;
    connection_t q1_t2_connections[1][1] =
        {{0, 0}};

    if (q1(n, q1_t2_connections))
    {
        printf("Q1 TestCase 4: " PASSED);
    }
    else
    {
        printf("Q1 TestCase 4: " FAILED);
    }
}
}
{
...
}
{
    ...
    int k = 2;
    int n = 5;
    connection_t q2_t1_connections[5][5] = {
        {{0, 0}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}},
        {{INT_MAX, INT_MAX}, {0, 0}, {2, 3}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}},
        {{INT_MAX, INT_MAX}, {3, 3}, {0, 0}, {3, 3}, {INT_MAX, INT_MAX}},
        {{INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {0, 0}, {INT_MAX, INT_MAX}},
        {{INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {3, 4}, {0, 0}}};
    if (!q2(&src, &dest, n, k, q2_t1_connections))
    {
...
}
{
    ...
    int n = 4;
    connection_t q2_t1_connections[4][4] = {
        {{0, 0}, {4, 5}, {INT_MAX, INT_MAX}, {4, 5}},
        {{INT_MAX, INT_MAX}, {0, 0}, {2, 3}, {INT_MAX, INT_MAX}},
        {{INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {0, 0}, {3, 3}},
        {{INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {0, 0}}

    };
    if (q2(&src, &dest, n, k, q2_t1_connections))
    {
        printf("Q2 TestCase 4: " PASSED);
    }
    else
    {
        printf("Q2 TestCase 4: " FAILED);
    }
}
{
    airport_t src = {5, "BLR"};
    airport_t dest = {0, "MUM"};
    int k = 3;
    int n = 6;
    connection_t q3_t1_connections[6][6] = {
        {{0, 0}, {1, 2}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}},
        {{INT_MAX, INT_MAX}, {0, 0}, {2, 3}, {3, 3}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}},
        {{2, 3}, {INT_MAX, INT_MAX}, {0, 0}, {3, 3}, {4, 4}, {INT_MAX, INT_MAX}},
        {{INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {0, 0}, {4, 4}, {INT_MAX, INT_MAX}},
        {{INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {0, 0}, {5, 5}},
        {{INT_MAX, INT_MAX}, {1, 1}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {0, 0}}};
    if (q2(&src, &dest, n, k, q3_t1_connections))
    {
        printf("Q2 TestCase 5: " PASSED);
    }
    else
    {
        printf("Q2 TestCase 5: " FAILED);
    }
}
}
{
...
}
{
    ...
    int n = 6;
    connection_t q3_t1_connections[6][6] = {
        {{0, 0}, {1, 2}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}},
        {{3, 5}, {0, 0}, {2, 3}, {3, 3}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}},
        {{INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {0, 0}, {3, 3}, {4, 4}, {INT_MAX, INT_MAX}},
        {{INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {0, 0}, {4, 4}},
        {{INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {0, 0}, {5, 5}},
        {{INT_MAX, INT_MAX}, {2, 4}, {INT_MAX, INT_MAX}, {INT_MAX, INT_MAX}, {0, 0}}};
...
}
{
    ...
    const char *pat = "KH";
    int contains[3] = {0, 0, 0};
    airport_t q7_t2_airports[] = {{0, "SHARUKH KHAN"}, {1, "KHAN"}, {2, "KOL"}};
